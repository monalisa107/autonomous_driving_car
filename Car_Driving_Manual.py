# -*- coding: utf-8 -*-
"""
Created on Mon May  3 08:43:32 2021
...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 28 20:01:42 2021
...
if __name__ == "__main__":
    ...
    while isopen:
        ...
        while True:
            ...
            steps += 1
            isopen = env.render()
            temp = env.observation_space
            
            # code to take a snapshot of current state of game
            #temp = env.viewer.get_array()
            #plt.imsave('temp_{0}.png'.format(increment), temp)
